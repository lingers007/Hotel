<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CBooking.aspx.cs" Inherits="CBooking" %>
...
<body>
    ...
    <div>
    <table align="center" border="1px" bordercolor="blue" style="width: 830px">
        <tr>
            <td align="center" class="style4" 
                ...
                BOOKED AND PENDING&nbsp; APARTMENT<br />
                <br />
        <table border="1" 
 ...
 <td class="style61" style="font-size: medium; font-weight: bold">
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id, Surname,Firstname,Phone,Depature,ArrivalD,DepatureD,Room_Name,Room_Type,Smoking,CT,Status,Control from Booking where Status='pending'   or Checkin='Yes'      and Type='Apartment'     order by id,ArrivalD ", dbConn);
                           ...
                           // Response.Write(A);
                              ...
                              var tt = sdz["ArrivalD"].ToString();
                                ...
                                else
                                {
                                    ...
                                    Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td><td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Room_Name"].ToString() + "</td><td>" + sdz["Room_Type"].ToString() + "</td><td>" + sdz["Smoking"].ToString() + "</td><td >" + kk + "</td><td class='style5'></a>&nbsp;&nbsp;&nbsp;&nbsp;  <a href='Checkout1.aspx?id=" + sdz["id"].ToString() + "'>Checkout</a> </td></tr>");
                                     
                                    
                                }
                               

                                //Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td><td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Room_Name"].ToString() + "</td><td>" + sdz["Room_Type"].ToString() + "</td><td>" + sdz["Smoking"].ToString() + "</td><td >" + kk + "</td><td class='style5'><a href='Addition.aspx?id=" + sdz["id"].ToString() + "'>Approve</a>&nbsp;&nbsp;&nbsp;&nbsp;  <a href='Delete.aspx?id=" + sdz["id"].ToString() + "'>Decline</a> </td></tr>");
                                ct++;
