...
using System.Data;
using System.Data.SqlClient;
public partial class ViewGym : System.Web.UI.Page
{
      ...
      //  Response.Write(cd);
       // Response.Write(Convert.ToDateTime(RadDatePicker1.SelectedDate.Value.ToShortDateString()));
        ...
        else
        {
            ...
            selectSQL = "select * from Gym where ArrivalD >=  '" + RadDatePicker3.SelectedDate.Value.ToShortDateString() + "' and  DepatureD <= '" + RadDatePicker4.SelectedDate.Value.ToShortDateString() + "' ";
