<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gas3rd.aspx.cs" Inherits="Gas3rd" %>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 825px">
        ...
        <table border="1" 
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id,Flatname,Original,Destination,Action,ShortD,Posted from Gas  where      ShortD  >= '" + (Session["D"].ToString()) + "' and   ShortD <= '" + (Session["D1"].ToString()) + "' and Type='Hotel'    order by ShortD Asc ", dbConn);
                            ...
                            while (sdz.Read())
                            {
                              ...
                              //  var y = DateTime.Parse(tt1).ToShortDateString();
                                    ...
                                    Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Flatname"].ToString() + "</td><td class='style2'>" + sdz["Original"].ToString() + "</td><td class='style2'>" + sdz["Destination"].ToString() + "</td>   <td class='style2'>" + sdz["Action"].ToString() + "</td><td class='style2'>" + x + "</td><td>" + sdz["Posted"].ToString() + "</td></tr>");
