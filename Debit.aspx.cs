...
public partial class Debit : System.Web.UI.Page
{
    ...
    protected void OnConfirm(object sender, EventArgs e)
    {
      ...
      // Response.Write(x);
        ...
        insertSQL = "INSERT INTO Debit(";
        insertSQL += "Name,Room,Descrip,Amount,Posted,Updated,DateS,LongD,Type)";
        insertSQL += "VALUES('";
        insertSQL += TextBox1.Text.Trim() + "','";
        insertSQL += DropDownList4.SelectedItem  + "','";
        ...
        try
        {
            ...
            if (added == 1)
            {
                ...
                Response.Redirect("DThanks.aspx");
