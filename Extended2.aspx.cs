...
public partial class Extended2 : System.Web.UI.Page
{
    string selectSQL;
    string selectSQL3;
    string selectSQL23;
    ...
    protected void OnConfirm(object sender, EventArgs e)
    {
        ...
        if (confirmValue == "Yes")
        {
            ...
            {
                updateSQL6 = "update Booking set DepatureD ='" + RadDatePicker2.SelectedDate.Value.ToShortDateString() + "' ,Depature ='" + RadDatePicker2.SelectedDate.Value + "'  where  id ='" + Session["id"].ToString() + "' and Type='Hotel'";
                ...
                try
                {
                    ...
                    if (updated2 == 1)
                    {
                        Response.Redirect("Extend2.aspx");
                    }
                    else
                    {
