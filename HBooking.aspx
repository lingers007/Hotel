<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HBooking.aspx.cs" Inherits="HBooking" %>
...
<body>
   ...
   <td class="style63" style="font-size: medium; font-weight: bold">
                    Smok.Stat</td>
                    <td class="style64" style="font-size: medium; font-weight: bold">
                    Status</td>
            ...
            <%
                ...
                SqlCommand scz =   new SqlCommand("select id, Surname,Firstname,Phone,Depature,ArrivalD,DepatureD,Room_Name,Room_Type,Smoking,CT,Status,Control from Booking where Status='pending' or Checkin='Yes' and Type='Hotel' order by id,ArrivalD ", dbConn);
                           ...
                           // Response.Write(A);
                              ...
                              var tt = sdz["ArrivalD"].ToString();
                                ...
                                else
                                {
                                    ...
                                    Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td><td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Room_Name"].ToString() + "</td><td>" + sdz["Room_Type"].ToString() + "</td><td>" + sdz["Smoking"].ToString() + "</td><td >" + kk + "</td><td class='style5'></a>&nbsp;&nbsp;&nbsp;&nbsp;  <a href='Checkout3.aspx?id=" + sdz["id"].ToString() + "'>Checkout</a> </td></tr>");
