                        ...
                        try
                        {
                            ...
                            if (dr14.Read())
                            {
                                ...
                                if (Session["AA"] == "" && Session["DD"] == "")
                                {
                                    ...
                                    insertSQL += "Surname,Firstname,Email,Phone,Price,Room_Type,Arrival,Depature,ArrivalD,DepatureD,Smoking,CT,Status,Discount,Control)";
                                    insertSQL += "VALUES('";
                ...
                try
                {
                    ...
                    if (dr1.Read())
                    {
                        ...
                        if (dd >= 15)
                        {
                            ...
                            {
                                Label6.Text = "Error  bGetting Room ";
                                Label6.Text += err.ToString();
                            }
                            finally
                            {
