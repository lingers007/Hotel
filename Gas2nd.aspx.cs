...
using System.Data;
using System.Data.SqlClient;
public partial class Gas2nd : System.Web.UI.Page
{
      ...
      //  Response.Write(cd);
       // Response.Write(Convert.ToDateTime(RadDatePicker1.SelectedDate.Value.ToShortDateString()));
        ...
        else
        {
            ...
            selectSQL = "select * from Gas where ShortD >=  '" + RadDatePicker3.SelectedDate.Value.ToShortDateString() + "' and  ShortD <= '" + RadDatePicker4.SelectedDate.Value.ToShortDateString() + "' ";
