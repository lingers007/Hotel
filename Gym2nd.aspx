<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Gym2nd.aspx.cs" Inherits="Gym2nd" %>
...
<head id="Head1" runat="server">
    <title>REGISTER CLIENTS FOR HOTEL GYM</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
        ...
        <tr>
            <td align="center" class="style4" 
                ...
                <table style="width: 100%; height: 28px; color: #000080; background-color: #000099;">
                    ...
                    REGISTER CLIENTS FOR HOTEL GYM<br />
