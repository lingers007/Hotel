...
<head id="Head1" runat="server">
    <title>DELETE PENDING AND BOOKED APARTMENT</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
...
<body>
 ...
 <td class="style62" style="font-size: medium; font-weight: bold">
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id, Surname,Firstname,Phone,Depature,ArrivalD,DepatureD,Room_Name,Room_Type,CT,Status,Control,Type from Booking  order by Type,id,ArrivalD ", dbConn);
                           ...
                           // Response.Write(A);
                              ...
                              var tt = sdz["ArrivalD"].ToString();
                                ...
                                else
                                {
                                    ...
                                    Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td><td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Room_Name"].ToString() + "</td><td>" + sdz["Room_Type"].ToString() + "</td><td >" + kk + "</td><td>" + sdz["Type"].ToString() + "</td><td class='style5'><a href='Totally.aspx?id=" + sdz["id"].ToString() + "'> Delete Totally</a></td></tr>");
                ...
                <br />
                <br />
                        <img src="Images/Down.jpg" style="width: 970px; height: 120px" /><br />
                </td>
        </tr>
    </table>
