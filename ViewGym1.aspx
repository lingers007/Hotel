<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewGym1.aspx.cs" Inherits="ViewGym1" %>
                    ...
                    <tr>
                        <td style="background-color: #DAC16B" class="style5" align="right">
                                                         <asp:LinkButton ID="LinkButton2" runat="server" ForeColor="White" 
                                                              PostBackUrl="Home2.aspx" CausesValidation="False" onclick="LinkButton2_Click" 
