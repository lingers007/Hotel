...
public partial class CheckIn : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write();
        selectSQL23 = "select * from Booking WHERE id ='" + Session["id"].ToString() + "' and Status='Pending'";
        ...
        try
        {
            ...
            if (dr.Read())
            {
                ...
                Session["4"] = dr["Phone"].ToString();
                 ...
                 Session["7"] = x;
                 Session["8"] = y;
                 if (Session["price"].ToString() == "35000")
                 {
            ...
            this.Page.ClientScript.RegisterStartupScript(this.GetType(), "alert", "alert", true);
                ...
                try
                {
                  ...
                  if (Session["6"].ToString() == "2 Bed Apartment")
                        ...
                        try
                        {
                            ...
                            if (dr14.Read())
                            {
                                ...
                                if (Session["AA"] == "" && Session["DD"] == "")
                                {
                                    ...
                                    {
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "' , Status='Done',Status2='Approved',Status3='Approved',Status5='run',Checkin='Yes',pp ='0',bp ='0',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',Amount ='" + TextBox1.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Apartment'";
                                        ...
                                        try
                                        {
                                           ...
                                           // Response.Write(updateSQL6);
                                            ...
                                            if (updated2 == 1)
                                            {
                                                ...
                                                updateSQL1 = "update Rooms set  Status='Occupied' where  Room_Name ='" + DropDownList4.SelectedItem + "'";
                                    ...
                                    else if (DropDownList3.SelectedValue == "PART PAYMENT")
                                    {
                                        ...
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "', Status='Done',Amount='0',Status2='Approved',Status3='Approved',Status5='run',Checkin='Yes',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',pp ='" + TextBox2.Text + "' ,bp ='" + TextBox3.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Apartment'";
                                        //Response.Write(updateSQL6);
                                        dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
                                ...
                                else
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (DropDownList3.SelectedItem.ToString() == "FULL PAYMENT")
                                        {
                                            updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "' , Status='Done',Status2='Approved',Status3='Approved',Status5='run',pp ='0',Checkin='Yes',bp ='0',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',Amount ='" + TextBox1.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Apartment'";
                                            //Response.Write(updateSQL6);
                                            dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
                                        ...
                                        else if (DropDownList3.SelectedValue == "PART PAYMENT")
                                        {
                                            ...
                                            updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "', Status='Done',Amount='0',Status2='Approved',Status3='Approved',Checkin='Yes',Status5='run',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',pp ='" + TextBox2.Text + "' ,bp ='" + TextBox3.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Apartment'";
                                            //Response.Write(updateSQL6);
                                            dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
                     ...
                     else   if (Session["6"].ToString() == "Roof Top")
                        {
                            ...
                            try
                            {
                                ...
                                if (dr1.Read())
                                {
                                    ...
                                    else if (dd < 10)
                                    {
                                        ...
                                        selectSQL15 = "  SELECT *  from Booking where  Status='Done'and Status2='Approved' and Status3='Approved' and Room_Type='" + Session["6"].ToString() + "' and Room_Name='" + DropDownList4.SelectedItem + "' ORDER BY ID DESC  ";
                                        //yimak.Src = "passport/" + Session["AdmissionNo"].ToString() + ".jpg";
                                ...
                                else
                                {
                                    ...
                                    else if (DropDownList3.SelectedValue == "PART PAYMENT")
                                    {
                                        ...
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "', Status='Done',Amount='0',Status2='Approved',Status3='Approved',Checkin='Yes',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',pp ='" + TextBox2.Text + "' ,bp ='" + TextBox3.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Apartment'";
                                        //Response.Write(updateSQL6);
                                        dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
