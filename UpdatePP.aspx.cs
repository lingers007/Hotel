...
public partial class UpdatePP : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        Session["id"] = Request.QueryString["id"].ToString();
         selectSQL5 = "select * from Booking WHERE id ='" + Session["id"].ToString() + "' and Type='Apartment' ";
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        updateSQL6 = "update Booking set  bp='" +y + "' , pp='" + z + "'where  id ='" + Session["id"].ToString() + "' and Type='Apartment' ";
