...
using System.Data;
using System.Data.SqlClient;
public partial class ViewGym1 : System.Web.UI.Page
{
      ...
      //  Response.Write(cd);
       // Response.Write(Convert.ToDateTime(RadDatePicker1.SelectedDate.Value.ToShortDateString()));
        ...
        else
        {
            ...
            selectSQL = "select * from Gym where ArrivalD >=  '" + RadDatePicker3.SelectedDate.Value.ToShortDateString() + "' and  DepatureD <= '" + RadDatePicker4.SelectedDate.Value.ToShortDateString() + "' and Type='Apartment' ";
         dbConn.ConnectionString ="Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";         // dbConn.ConnectionString = "Data Source=LAPTOP-VOQ43JBA\\SQLEXPRESS; Initial Catalog=da24;Integrated Security=True;"; 
            ...
            try
            {
               ...
               // Response.Write(selectSQL);
                ...
                if (dr.Read())
                {
                    ...
                    Response.Redirect("GymView1.aspx");
                }
