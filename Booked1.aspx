<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Booked1.aspx.cs" Inherits="Booked1" %>
...
<head id="Head1" runat="server">
    <title>VIEW OCCUPIED ROOM</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 825px">
        ...
        <table border="1" 
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select sid, Room_Name,Room_Type,Status from Rooms where  Type='Hotel' and Status='Occupied'   order by Room_Type Asc ", dbConn);
