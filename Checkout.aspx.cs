...
public partial class Checkout : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        //Response.Write();
        selectSQL23 = "select * from Booking WHERE id ='" + Session["id"].ToString() + "' and Status2='Approved'  and Type='Apartment' ";
 // Response.Write(selectSQL23);
        ...
        try
        {
            ...
            if (dr.Read())  
            {
                ...
                updateSQL6 = "update Booking set Status3 ='Checkout',Status5='free',  Checkin='NULL'  where  id ='" + Session["id"].ToString() + " '  and Type='Apartment'";
               // Response.Write(updateSQL6);
                ...
                try
                {
                    ...
                    if (updated2 == 1)
                    {
                        updateSQL7 = "update Rooms set Status ='Free' where  Room_Name ='" + Session["R"].ToString() + "' and Room_Type ='" + Session["T"].ToString() + "' and Type='Apartment' ";
