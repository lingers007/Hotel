...
public partial class CheckIn3 : System.Web.UI.Page
{
    String selectSQL91;
    String selectSQL95;
    String selectSQL13;
                                ...
                                else if (dd < 11)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            if (DropDownList3.SelectedItem.ToString() == "FULL PAYMENT")
                                            {
                                                updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "' , Status='Done',Status2='Approved',Status3='Approved',Status5='run',pp ='0',bp ='0',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',Amount ='" + TextBox1.Text + "' where  id ='" + Session["id"].ToString() + "' and Type='Hotel' ";
                                                //Response.Write(updateSQL6);
                                                dbConn6.ConnectionString ="Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
