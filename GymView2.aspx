<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GymView2.aspx.cs" Inherits="GymView2" %>
...
<body>
    ...
    <table align="center" border="1px" bordercolor="blue" 
            style="width: 772px; height: 728px;">
        <tr>
        ...
        <table border="1" 
                    ...
                    style="width: 1062px; font-family: Candara; font-size: small; font-weight: normal;">
            <tr>
            <td class="style47" 
                ...
                <td class="style66" style="font-size: medium; font-weight: bold">
                    ...
                    <td class="style65" style="font-size: medium; font-weight: bold">
                  </td>
            </tr>
            <%
                
                
                SqlCommand scz = new SqlCommand("select id, Surname,Firstname,Phone,Arrival,Depature,ArrivalD,DepatureD,Status,Price from Gym    where  Arrival  >= '" + (Session["D"].ToString()) + "' and Depature <= '" + (Session["D1"].ToString()) + "' and Type='Hotel' ", dbConn);
                            ...
                            while (sdz.Read())
                            {
                              ...
                              var tt = sdz["ArrivalD"].ToString();
                                ...
                                Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td> <td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Status"].ToString() + "</td> <td class='style2'>" + sdz["Price"].ToString() + "</td><td class='style5'><a href='DeleteGym1.aspx?id=" + sdz["id"].ToString() + "'>Delete Record</a></td></tr>");
            ...
            <td class="style47" 
                ...
                <br />
                <br />
                        <img src="Images/Down.jpg" style="width: 1063px; height: 120px" /><br />
                </td>
        </tr>
    </table>
