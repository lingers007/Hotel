...
using System.Data;
using System.Data.SqlClient;
public partial class Debit2nd : System.Web.UI.Page
{
      ...
      //  Response.Write(cd);
       // Response.Write(Convert.ToDateTime(RadDatePicker1.SelectedDate.Value.ToShortDateString()));
        ...
        else
        {
            ...
            selectSQL = "select * from Debit where DateS >=  '" + RadDatePicker3.SelectedDate.Value.ToShortDateString() + "' and  DateS <= '" + RadDatePicker4.SelectedDate.Value.ToShortDateString() + "' ";
            ...
            try
            {
               ...
               // Response.Write(selectSQL);
                ...
                if (dr.Read())
                {
                    ...
                    Response.Redirect("Debit3rd.aspx");
                }
