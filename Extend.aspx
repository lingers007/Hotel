<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Extend.aspx.cs" Inherits="Extend" %>
    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        ...
        <table border="1" 
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id, Surname,Firstname,Phone,Depature,ArrivalD,DepatureD,Room_Name,Room_Type,CT,Status,Control from Booking where  Status='Done' and Status2='Approved' and  Status3='Approved' order by id,ArrivalD ", dbConn);
