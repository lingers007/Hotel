            ...
            <td align="center" class="style4" 
                ...
                <b style="font-size: normal;">
                            <asp:DropDownList ID="DropDownList1" runat="server" Height="36px" Width="211px">
                                <asp:ListItem>Choose a Query</asp:ListItem>
                                <asp:ListItem Value="Checkout">View Completed Reservation</asp:ListItem>
                ...
                <b style="font-size: normal;">
                                ...
                                ControlToValidate="DropDownList1" ErrorMessage="Choose a Query" Font-Bold="True" 
                                Font-Size="Small" Operator="NotEqual" ValueToCompare="Choose a Query" 
                                Width="145px" Height="24px"></asp:CompareValidator>
                </b>
