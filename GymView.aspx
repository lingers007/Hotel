<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GymView.aspx.cs" Inherits="GymView" %>
                ...
                SqlCommand scz = new SqlCommand("select id, Surname,Firstname,Phone,Arrival,Depature,ArrivalD,DepatureD,Status,Price from Gym    where  Arrival  >= '" + (Session["D"].ToString()) + "' and Depature <= '" + (Session["D1"].ToString()) + "' and Type='Apartment' ", dbConn);
                            ...
                            while (sdz.Read())
                            {
                              ...
                              var tt = sdz["ArrivalD"].ToString();
                                ...
                                Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Surname"].ToString() + "</td><td class='style2'>" + sdz["Firstname"].ToString() + "</td> <td class='style2'>" + sdz["Phone"].ToString() + "</td><td class='style2'>" + x + "</td><td class='style2'>" + y + "</td><td class='style2'>" + sdz["Status"].ToString() + "</td> <td class='style2'>" + sdz["Price"].ToString() + "</td><td class='style5'><a href='DeleteGym.aspx?id=" + sdz["id"].ToString() + "'>Delete Record</a></td></tr>");
