<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DThanks.aspx.cs" Inherits="DThanks" %>
...
<head id="Head1" runat="server">
    <title>ADD DEBIT NOTE  CONFIRMATION</title>
    <style type="text/css">
        .style4
        {
            width: 709px;
        ...
        <tr>
            <td align="center" class="style4" 
                ...
                <br />
                        ...
                        <br />
                    You Have Succesfully Added Debit Note&nbsp; 
                    <br />
                <br />
                <br />
                        <br />
