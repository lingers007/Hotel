    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            ...
            <%
                   ...
                   SqlCommand scz = new SqlCommand("select Room_Name,Room_Type from Booking  where   Status='Done' and  Status2='Approved'  and  Status3='Approved  ' and Type='Apartment' ", dbConn);
