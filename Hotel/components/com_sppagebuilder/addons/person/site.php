...
class SppagebuilderAddonPerson extends SppagebuilderAddons{
	...
	public function render() {
		...
		if($facebook || $twitter || $google_plus || $youtube || $linkedin || $pinterest || $flickr || $dribbble || $behance || $instagram) {
			...
			if($facebook) 		$social_icons .= '<li><a target="_blank" href="' . $facebook . '" aria-label="Facebook"><i class="fa fa-facebook" aria-hidden="true" title="Facebook"></i></a></li>';
			if($twitter) 		$social_icons .= '<li><a target="_blank" href="' . $twitter . '" aria-label="Twitter"><i class="fa fa-twitter" aria-hidden="true" title="Twitter"></i></a></li>';
			if($google_plus) 	$social_icons .= '<li><a target="_blank" href="' . $google_plus . '" aria-label="Google Plus"><i class="fa fa-google-plus" aria-hidden="true" title="Google Plus"></i></a></li>';
			if($youtube) 		$social_icons .= '<li><a target="_blank" href="' . $youtube . '" aria-label="YouTube"><i class="fa fa-youtube" aria-hidden="true" title="YouTube"></i></a></li>';
			if($linkedin) 		$social_icons .= '<li><a target="_blank" href="' . $linkedin . '" aria-label="LinkedIn"><i class="fa fa-linkedin" aria-hidden="true" title="LinkedIn"></i></a></li>';
			if($pinterest) 		$social_icons .= '<li><a target="_blank" href="' . $pinterest . '" aria-label="Pinterest"><i class="fa fa-pinterest" aria-hidden="true" title="Pinterest"></i></a></li>';
			if($flickr) 		$social_icons .= '<li><a target="_blank" href="' . $flickr . '" aria-label="Flickr"><i class="fa fa-flickr" aria-hidden="true" title="Flickr"></i></a></li>';
			if($dribbble) 		$social_icons .= '<li><a target="_blank" href="' . $dribbble . '" aria-label="Dribble"><i class="fa fa-dribbble" aria-hidden="true" title="Dribble"></i></a></li>';
			if($behance) 		$social_icons .= '<li><a target="_blank" href="' . $behance . '" aria-label="Behance"><i class="fa fa-behance" aria-hidden="true" title="Behance"></i></a></li>';
			if($instagram) 		$social_icons .= '<li><a target="_blank" href="' . $instagram . '" aria-label="Instagram"><i class="fa fa-instagram" aria-hidden="true" title="Instagram"></i></a></li>';
