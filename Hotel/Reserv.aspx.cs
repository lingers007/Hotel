...
public partial class Reserv : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        {
            if (DropDownList1.SelectedItem.ToString() == "Deluxe")
            {
                ...
                try
                {
                    ...
                    if (dr1.Read())
                    {
                        ...
                        if (dd >= 9)
                        {
                            ...
                            try
                            {
                                ...
                                if (dr14.Read())
                                {
                                    ...
                                    Label6.Text = "Deluxe Not Available Till " + V;
                        ...
                        //Label6.Text = "Deluxe Not Availbale";
                    }
                    else
                    {
            ...
            else if (DropDownList1.SelectedItem.ToString() == "Executive")
            {
                selectSQL = "  SELECT  Price  FROM Rooms where  Room_Type='" + DropDownList1.SelectedItem.Text + "'    ";
                //yimak.Src = "passport/" + Session["AdmissionNo"].ToString() + ".jpg";
                        ...
                        if (dd >= 25)
                        {
                            ...
                            try
                            {
                                ...
                                if (dr14.Read())
                                {
                                    ...
                                    Label6.Text = "Executive Not Available Till " + V;
            ...
            else if (DropDownList1.SelectedItem.ToString() == "Standard")
            {
                selectSQL = "  SELECT  Price  FROM Rooms where  Room_Type='" + DropDownList1.SelectedItem.Text + "'    ";
                //yimak.Src = "passport/" + Session["AdmissionNo"].ToString() + ".jpg";
                        ...
                        if (dd >= 11)
                        {
                            ...
                            try
                            {
                                ...
                                if (dr14.Read())
                                {
                                    ...
                                    Label6.Text = "Standard Room Not Available Till " + V;
