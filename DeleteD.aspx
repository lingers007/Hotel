    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 811px">
        <tr>
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("SELECT  id,Dis,Number  FROM Discount ", dbConn);
                            ...
                            while (sdz.Read())
                            {
                                ...
                                Response.Write("<tr style><td class='style2'>" + sdz["id"].ToString() + "</td><td class='style5'>" + sdz["Dis"].ToString() + "</td><td class='style5'>" + sdz["Number"].ToString() + "</td><td class='style5'>&nbsp;&nbsp;&nbsp;  <a href='Delete3.aspx?id=" + sdz["id"].ToString() + " '>Delete Code</a> </td> </tr>");
