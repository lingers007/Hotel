    ...
    <table align="center" border="1px" bordercolor="blue" style="width: 825px">
        ...
        <table border="1" 
            ...
            <%
                ...
                SqlCommand scz = new SqlCommand("select id, Room,Name,Descrip,Amount,Posted,Updated,DateS from Debit where  DateS >= '" + (Session["D"].ToString()) + "' and   DateS <= '" + (Session["D1"].ToString()) + "'   order by DateS Asc ", dbConn);
                            ...
                            while (sdz.Read())
                            {
                              ...
                              //  var y = DateTime.Parse(tt1).ToShortDateString();
                                    ...
                                    Response.Write("<tr style><td class='style2'>" + ct++ + "</td><td class='style2'>" + sdz["Room"].ToString() + "</td><td class='style2'>" + sdz["Name"].ToString() + "</td><td class='style2'>" + sdz["Descrip"].ToString() + "</td>   <td class='style2'>" + sdz["Amount"].ToString() + "</td><td class='style2'>" + x + "</td><td>" + sdz["Posted"].ToString() + "</td><td>" + sdz["Updated"].ToString() + "</td>   </tr>");
