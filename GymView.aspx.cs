...
public partial class GymView : System.Web.UI.Page
{
    string selectSQL;
    string updateSQL;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     dbConn.ConnectionString = "Data Source=67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
        ...
        selectSQL = "select 'Nam1'=(select Sum(Price)   from Gym    where  Arrival  >= '" + Session["D"].ToString() + "' and Depature <= '" + Session["D1"].ToString()+ "' and Type='Apartment') from Gym ";
