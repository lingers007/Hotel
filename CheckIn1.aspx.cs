                        ...
                        try
                        {
                            ...
                            if (dr14.Read())
                            {
                                ...
                                if (Session["AA"] == "" && Session["DD"] == "")
                                {
                                    ...
                                    {
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "' , Status='Done',Status2='Approved',Status3='Approved',Status5='run',pp ='0',bp ='0',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',Amount ='" + TextBox1.Text + "' where  id ='" + Session["id"].ToString() + "'";
                                        ...
                                        try
                                        {
                                           ...
                                           // Response.Write(updateSQL6);
                                            ...
                                            if (updated2 == 1)
                                            {
                                              ...
                                              Response.Redirect("CBooking.aspx");
                                                }
                                                else
                                                {
                                    ...
                                    else if (DropDownList3.SelectedValue == "PART PAYMENT")
                                    {
                                        ...
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "', Status='Done',Amount='0',Status2='Approved',Status3='Approved',Status5='run',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',pp ='" + TextBox2.Text + "' ,bp ='" + TextBox3.Text + "' where  id ='" + Session["id"].ToString() + "'";
                                        //Response.Write(updateSQL6);
                                        dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    else if (DropDownList3.SelectedValue == "PART PAYMENT")
                                    {
                                        ...
                                        updateSQL6 = "update Booking set Room_Name='" + DropDownList4.SelectedItem + "', Status='Done',Amount='0',Status2='Approved',Status3='Approved',Payment ='" + DropDownList2.SelectedItem.Text + "',Pt ='" + DropDownList3.SelectedItem.Text + "',pp ='" + TextBox2.Text + "' ,bp ='" + TextBox3.Text + "' where  id ='" + Session["id"].ToString() + "'";
                                        //Response.Write(updateSQL6);
                                        dbConn6.ConnectionString = "Data Source= 67.211.215.196;Initial Catalog=da24;User ID=sa;password=Dao247server%;Integrated Security=false;";
