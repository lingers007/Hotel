...
jQuery(document).ready(function($){
    ...
    jQuery(".topdf").click(function(event) {
        ...
        jQuery.post(
            "wp-content/themes/Divi-child/functions/generatePDF.html",
            {
                mycontent: html
            },
            function(data) {
    ...
    var pageName = currentURL.split("index.html");

    console.log("aaaaaaaaaaaa");
    console.log(currentURL);
    if (currentURL.toLowerCase().indexOf("location/index.html") > -1 ||
        currentURL.toLowerCase().indexOf("gallery/index.html") > -1 ||
        currentURL.toLowerCase().indexOf("offers/index.html") > -1 ||
        currentURL.toLowerCase().indexOf("spa-at-the-landmark-london/index.html") > -1) {
    ...
    if (currentURL.toLowerCase().indexOf("dining/index.html") >= 0 && pageName[pageName.length-2] != "dining"){
        jQuery(".back_to_section").show();
    ...
    if (currentURL.toLowerCase().indexOf("meetings-events/index.html") >= 0 && pageName[pageName.length-2] != "meetings-events"){
        jQuery(".back_to_section").show();
