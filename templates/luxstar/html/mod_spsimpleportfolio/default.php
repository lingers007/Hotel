						...
						<div class="sp-vertical-middle">
							<div>
								<div class="sp-simpleportfolio-btns">
									<?php if( $item->video ) { ?>
										<a class="btn-zoom" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $item->id; ?>"><i class="fa fa fa-play p_color" aria-hidden="true"></i></a>
									<?php } else { ?>
										<a class="btn-zoom" href="<?php echo $item->popup_img_url; ?>" data-featherlight="image"><i class="fa fa-search-plus p_color" aria-hidden="true"></i></a>
									<?php } ?>
									<a class="btn-view" href="<?php echo $item->url; ?>"><i class="fa fa-chain p_color" aria-hidden="true"></i></a>
								</div>
