...
?>
<div itemscope itemtype="http://schema.org/ItemList" class="j2store-product-modulepace gggr j2store-product-module-list row-fluid">
<?php if( count($list) > 0 ):?>
<?php foreach ($list as $product_id => $product) : ?>
	<?php  $rowcount = ((int) $counter % (int) $total_cols) + 1; ?> 
	<!-- single product -->
	
	<div class="j2store product-<?php echo $product->j2store_product_id; ?> j2store-module-product col-sm-<?php echo round((12 / $total_cols));?> ">
