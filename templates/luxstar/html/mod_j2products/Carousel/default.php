...
$total_cols = $params->get('number_of_coloums', 4);
$total_colsDesktop = $params->get('number_of_coloums_Desktop', 4);
$total_colsDesktopSmall = $params->get('number_of_coloums_DesktopSmall', 2);
$total_colsTablet = $params->get('number_of_coloums_Tablet', 3);
$total_colsTabletSmall = $params->get('number_of_coloums_TabletSmall', 1);
		...
		<div class="product_cart_block">
			...
			<?php if($j2params->get('catalog_mode', 0) == 0 ): ?>
				...
				<?php if ($product->display_cart_block): ?>
					...
					<?php if($params->get('show_qty_field', 0)): ?>
