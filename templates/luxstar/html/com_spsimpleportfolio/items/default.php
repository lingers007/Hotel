					...
					<div class="sp-vertical-middle">
						<div>
							<div class="sp-simpleportfolio-btns">
								<?php if( $this->item->video ) { ?>
								<a class="btn-zoom" href="#" data-featherlight="#sp-simpleportfolio-video<?php echo $this->item->id; ?>"> <i class="fa fa-play"></i></a>
								<?php } else { ?>
								<a class="btn-zoom" href="<?php echo $this->item->image; ?>" data-featherlight="image"> <i class="fa fa-expand"></i></a>
								<?php } ?>
								<a class="btn-view" href="<?php echo $this->item->url; ?>"> <i class="fa fa-link"></i></a>
							</div>
