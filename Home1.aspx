                            ...
                            <tr>
                                <td align="center">
                                    <asp:HyperLink ID="HyperLink1" runat="server" ForeColor="White" 
                                        NavigateUrl="ViewB.aspx">View Bookings</asp:HyperLink>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center">
                                    <asp:HyperLink ID="HyperLink5" runat="server" ForeColor="White" 
                                        NavigateUrl="Passwordh.aspx">Change Password</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="style6" align="center">
                                    <asp:HyperLink ID="HyperLink2" runat="server" ForeColor="White" 
                                        NavigateUrl="Vacant.aspx">View Vacant Apartment</asp:HyperLink>
                                </td>
                            </tr>
                                ...
                                <td align="center">
                                    <asp:HyperLink ID="HyperLink6" runat="server" ForeColor="White" 
                                        NavigateUrl="Gas.aspx">Gas Record </asp:HyperLink>                                   
                            ...
                            <tr>
                                <td align="center">
                                    <asp:HyperLink ID="HyperLink9" runat="server" ForeColor="White" 
                                        NavigateUrl="VGas.aspx">View Gas Record </asp:HyperLink> </td>
                            </tr>
                            ...
                            <tr>
                                <td class="style6" align="center">
                                    <asp:HyperLink ID="HyperLink3" runat="server" ForeColor="White" 
                                        NavigateUrl="Booked.aspx">View Occupied Apartment</asp:HyperLink>
                                </td>
                            </tr>
                            <tr>
                                <td class="style6" align="center">
                                    <asp:HyperLink ID="HyperLink4" runat="server" ForeColor="White" 
                                        NavigateUrl="UpdateP.aspx">Update Payment or Print Reciept</asp:HyperLink>
                                </td>
                            </tr>
 <tr>
                                <td class="style6" align="center">
                                    <asp:HyperLink ID="HyperLink40" runat="server" ForeColor="White" 
                                        NavigateUrl="Extend.aspx">Extend Booking</asp:HyperLink>
                                </td>
                            </tr>
                </table>
                        <br />
